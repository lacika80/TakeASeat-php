<div class="d-flex justify-content justify-content-center">
    <div class="d-flex justify-content-center flex-wrap vertical-center" style="">
        ...
        <div class="d-flex flex-column my-auto text-center my-5" style="width: 30rem" id="regContainer">
            ...
            <form id="regForm" style="width: 50rem; text-align: left"
                  onsubmit="getData('Login/register', 'regForm')"
            ...
            <div class="mt-1 d-flex justify-content-evenly">
                <button class="btn" style="width: 50%; color: white" onclick="callLogin()">inkább bejelentkezek</button>
            </div>
        ...
        <div class="d-flex flex-column my-5 text-center" style="width: 30rem" id="loginContainer">
            ...
            <hr class="mx-auto" style="width: 20rem; border-top: 2px solid #171717">
            <form id="loginForm" style="width: 30rem; text-align: left"
                  onsubmit="getData('Login/login', 'loginForm')"
                  class="mx-auto d-flex flex-column ">

                <label for="email" class=" mb-0 text-light mx-auto" style="width: 65%">Email cím</label>
                <input type="email" class="form-control mx-auto" id="email" name="email" style="width: 70%" required>
                <label for="password" class="mt-3 mb-0 text-light mx-auto" style="width: 65%">Jelszó</label>
                <input type="password" class="form-control mx-auto" style="width: 70%" name="password" id="password"
                       required>
                <input type="submit" class="btn mx-auto mt-2" style="width: 30%; color: white" value="bejelentkezés">
            </form>
            <hr class="mx-auto my-2" style="width: 20rem; border-top: 2px solid #171717">
            <div class="mt-1 d-flex justify-content-evenly">
                <button class="btn" style="width: 25%; color: white" onclick="callReg()">Regisztráció</button>
            ...
            <button class="btn btn-danger mx-auto mb-3" style="width: 15rem"
                    onclick="window.location='<?php echo $data["loginURL"]; ?>'">Login with Google
